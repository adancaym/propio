...
class Persona_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        $this->db->like('idpersona', $q);
	$this->db->or_like('correo', $q);
	$this->db->or_like('Nombre', $q);
	$this->db->or_like('paterno', $q);
	$this->db->or_like('materno', $q);
	$this->db->or_like('grado_escolar', $q);
    ...
    function get_dropdown($campo){
        ...
        foreach ($this->db->get($this->table)->result_array() as $row ) {
            $options[$category['idpersona']] =  $category[$campo];
        }
        return form_dropdown('idpersona', $options, '','class="form-control"');
    }
    //funcion generadora de select html con clase bootstrap
