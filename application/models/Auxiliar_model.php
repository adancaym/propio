...
class Auxiliar_model extends CI_Model
{
    ...
    function get_dropdown($campo){
        ...
        foreach ($this->db->get($this->table)->result_array() as $row ) {
            $options[$category['idauxiliar']] =  $category[$campo];
        }
        return form_dropdown('idauxiliar', $options, '','class="form-control"');
    }
    //funcion generadora de select html con clase bootstrap
...
/* End of file Auxiliar_model.php */
/* Location: ./application/models/Auxiliar_model.php */
