...
class Personas_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        $this->db->like('idpersonas', $q);
	$this->db->or_like('nombre', $q);
	$this->db->or_like('apellido_paterno', $q);
	$this->db->or_like('apellido_materno', $q);
	$this->db->or_like('contacto_correo', $q);
	$this->db->or_like('titulo_academico_idtitulo_academico', $q);
    ...
    function get_dropdown($campo){
        ...
        foreach ($this->db->get($this->table)->result_array() as $row ) {
            $options[$category['idpersonas']] =  $category[$campo];
        }
        return form_dropdown('idpersonas', $options, '','class="form-control"');
    }
    //funcion generadora de select html con clase bootstrap
