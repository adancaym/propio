...
class Especialidades_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        $this->db->like('idespecialidades', $q);
	$this->db->or_like('nombre', $q);
	$this->db->or_like('area_idarea', $q);
	$this->db->or_like('clv_esp', $q);
    ...
    function get_dropdown($campo){
        ...
        foreach ($this->db->get($this->table)->result_array() as $row ) {
            $options[$category['idespecialidades']] =  $category[$campo];
        }
        return form_dropdown('idespecialidades', $options, '','class="form-control"');
    }
    //funcion generadora de select html con clase bootstrap
...
/* End of file Especialidades_model.php */
/* Location: ./application/models/Especialidades_model.php */
