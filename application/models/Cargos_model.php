...
class Cargos_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        $this->db->like('idcargos', $q);
	$this->db->or_like('descripcion', $q);
	$this->db->or_like('unidad_idunidad', $q);
	$this->db->or_like('correo', $q);
	$this->db->or_like('unidad', $q);
	$this->db->or_like('persona_idpersona', $q);
    ...
    function get_dropdown($campo){
        ...
        foreach ($this->db->get($this->table)->result_array() as $row ) {
            $options[$category['idcargos']] =  $category[$campo];
        }
        return form_dropdown('idcargos', $options, '','class="form-control"');
    }
    //funcion generadora de select html con clase bootstrap
...
/* End of file Cargos_model.php */
/* Location: ./application/models/Cargos_model.php */
