...
class Contenidos_model extends CI_Model
{
    ...
    function total_rows($q = NULL) {
        $this->db->like('idcontenidos', $q);
	$this->db->or_like('titulo', $q);
	$this->db->or_like('contenido', $q);
	$this->db->or_like('auxiliar_idauxiliar', $q);
    ...
    function get_dropdown($campo){
        ...
        foreach ($this->db->get($this->table)->result_array() as $row ) {
            $options[$category['idcontenidos']] =  $category[$campo];
        }
        return form_dropdown('idcontenidos', $options, '','class="form-control"');
    }
    //funcion generadora de select html con clase bootstrap
